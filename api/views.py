...
class OrderApiHandler(BaseHandler):
	...
	def post(self, request):
		...
		transaction_info['amount'] = int(self.request.data['quantity']) * product_obj.price
		uhack_reponse = uhack.pay_amount(transaction_info)
		...
		return self.api_response(200, json.loads(uhack_reponse))
